...
if ( ! function_exists( 'um_theme_customizer_head_styles' ) ) {
	function um_theme_customizer_head_styles() {
		...
		$css .= '
			...
			.adverts-single-author-name,.meta,.comments-link a,.post-meta__time,.single.post-meta,.comment-reply-link,.post-meta__author,.comment-edit-link{color:' . sanitize_hex_color( $website_meta ) . ';}
		...
		if ( class_exists( 'UM' ) ) :
			...
			$css .='
				...
				.um-account-side li a:hover {background-color:' . sanitize_hex_color( $defaults['um_theme_um_account_tab_hover_color'] ) . '!important;}
