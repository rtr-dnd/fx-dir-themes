...
<ul id="forums-list-<?php bbp_forum_id(); ?>" class="bbp-forums">
	...
	<li class="bbp-header">
		...
		<ul class="boot-row forum-titles boot-align-items-center">
			...
			<li class="boot-col-md-1 bbp-forum-topic-count"><?php esc_html_e( 'Topics', 'um-theme' ); ?></li>
			...
			<li class="boot-col-md-3 bbp-forum-freshness"><?php esc_html_e( 'Recent Activity', 'um-theme' ); ?></li>
		</ul>
