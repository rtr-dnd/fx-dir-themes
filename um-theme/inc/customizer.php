...
function um_theme_customize_register( $wp_customize ) {
		...
		if ( ! class_exists( 'Google_Font_Dropdown_Custom_Control' ) ) {
			class Google_Font_Dropdown_Custom_Control extends WP_Customize_Control {
				...
				public function get_google_fonts() {
					...
					return isset( $content['items'] ) ? $content['items'] : false;
				}
			}
		}
	}
	...
	*/
	...
	$wp_customize->add_setting( 'customization[um_post_tag_box_bg]' ,
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'um_post_tag_box_bg',
			array(
	...
	$wp_customize->add_setting( 'customization[um_post_tag_text_color]',
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize,'um_post_tag_text_color',
			array(
