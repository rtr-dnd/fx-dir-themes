...
(function($) {
    ...
    // UM Messaging - Header Elements Divider Color
    wp.customize('customization[um_theme_header_messenger_divider_color]', function(value) {
        value.bind(function(newval) {
            $('.um-theme-dropdown-header,.header-messenger-box .dropdown-menu a,.header-notification-box .dropdown-menu a').css('border-color', newval);
        });
    });
